VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} SOLICITUDTC 
   Caption         =   "SOLICITUD DE TARJETA DE CRÉDITO - SIAF"
   ClientHeight    =   10185
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   15615
   OleObjectBlob   =   "SOLICITUDTC.frx":0000
   StartUpPosition =   2  'Centrar en pantalla
End
Attribute VB_Name = "SOLICITUDTC"
...
Sheets("SOLICITUD TC").Cells(90, 12) = ComboBox11.Text
PROCESO2.Show
...
TextBox7.Text = 999
If ComboBox2.Text = "VISA CLÁSICA" Then
Image2.Visible = True
...
ComboBox8.AddItem ("Día 10 de cada mes")
ComboBox8.AddItem ("Día 25 de cada mes")
Else
If ComboBox2.Text = "VISA ORO" Then
...
ComboBox8.AddItem ("Día 25 de cada mes")
Else
If ComboBox2.Text = "VISA PLATINUM" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = True
Image5.Visible = False
...
ComboBox8.AddItem ("Día 25 de cada mes")
Else
If ComboBox2.Text = "VISA SIGNATURE" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = True
...
ComboBox8.AddItem ("Día 25 de cada mes")
Else
If ComboBox2.Text = "MASTERCARD STANDARD" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
Image13.Visible = False
ComboBox8.AddItem ("Día 10 de cada mes")
ComboBox8.AddItem ("Día 20 de cada mes")
Else
If ComboBox2.Text = "MASTERCARD GOLD" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
ComboBox8.AddItem ("Día 20 de cada mes")
Else
If ComboBox2.Text = "MASTERCARD PLATINUM" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
ComboBox8.AddItem ("Día 20 de cada mes")
Else
If ComboBox2.Text = "MASTERCARD BLACK" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
ComboBox8.AddItem ("Día 20 de cada mes")
Else
If ComboBox2.Text = "AMEX CLÁSICA" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
Image12.Visible = False
Image13.Visible = False
ComboBox8.AddItem ("Día 22 de cada mes")
Else
If ComboBox2.Text = "AMEX GOLD" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
ComboBox8.AddItem ("Día 22 de cada mes")
Else
If ComboBox2.Text = "AMEX PLATINUM" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
ComboBox8.AddItem ("Día 22 de cada mes")
Else
If ComboBox2.Text = "AMEX BLACK" Then
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
...
End If
End If
Sheets("SOLICITUD TC").Cells(13, 2) = ComboBox2.Text
End Sub
...
Sheets("SOLICITUD TC").Cells(90, 4) = ComboBox5.Text
End Sub

Private Sub ComboBox6_Change()
Sheets("SOLICITUD TC").Cells(94, 2) = ComboBox6.Text
End Sub
...
' Definir las hojas de trabajo
    Set wsCartillaCuenta = ThisWorkbook.Sheets("SOLICITUD TC")
    ...
    wsCartillaCuenta.Range("T13:T17").Copy
    ...
    MsgBox "Completar Solicitud de Tarjeta de Crédito", , "SIAF v 1.2.0"
        Else
        If ComboBox2.Text = "" Or ComboBox5.Text = "" Or ComboBox6.Text = "" Or ComboBox8.Text = "" Or ComboBox11.Text = "" Then
        MsgBox "Completar Solicitud de Tarjeta de Crédito", , "SIAF v 1.2.0"
            Else
                ...
                Dim NombreArchivo, RutaArchivo As String
                    ...
                    NombreArchivo = "SOLICITUD DE TARJETA DE CRÉDITO" & " " & CStr(Format(Date, "dd-mm")) & " " & CStr(Format(Time, "hh-mm-ss"))
                    RutaArchivo = ActiveWorkbook.Path & "\" & NombreArchivo & ".pdf"
                    ActiveSheet.Range("A2:N143").Select
...
'Range("A1").Select 'celda final selecionada
                    Application.Visible = False
                     With ActiveSheet.PageSetup
                        ...
                        Dim NomreArchivo, Rutarchivo As String
                    Sheets("RESUMEN").Select
                    FECHA = Label1.Caption
                    NomreArchivo = "HOJA RESUMEN TARJETA DE CRÉDITO" & " " & CStr(Format(Date, "dd-mm")) & " " & CStr(Format(Time, "hh-mm-ss"))
                    Rutrchivo = ActiveWorkbook.Path & "\" & NomreArchivo & ".pdf"
                    ActiveSheet.Range("A1:AF37").Select
                    Selection.ExportAsFixedFormat Type:=xlTypePDF, Filename:=Rutrchivo, _
                    Quality:=xlQualityStandard, IncludeDocProperties:=True, _
                    IgnorePrintAreas:=False, OpenAfterPublish:=True
...
Sheets("SOLICITUD TC").Select
Range( _
        "D118,D122,D19:E19,G18,I19:J19,B23:E23,F23:I23,J23:M23,D25:E25,G25,J25:M25,B29:M29,B33:E33,F33:I33,J33:M33,B37,C37:E37,F37:I37,J37:M37,D39:G39,K39:M39,B43:E43,F43:I43,J43:M43" _
        ).Select
    Range("J43").Activate
...
If CDbl(TextBox12.Text) > 10000 Then
ComboBox2.AddItem ("VISA SIGNATURE")
ComboBox2.AddItem ("AMEX BLACK")
ComboBox2.AddItem ("MASTERCARD BLACK")
ComboBox2.AddItem ("VISA PLATINUM")
ComboBox2.AddItem ("AMEX PLATINUM")
ComboBox2.AddItem ("MASTERCARD PLATINUM")
ComboBox2.AddItem ("VISA ORO")
ComboBox2.AddItem ("AMEX GOLD")
ComboBox2.AddItem ("MASTERCARD GOLD")
ComboBox2.AddItem ("VISA CLÁSICA")
ComboBox2.AddItem ("AMEX CLÁSICA")
ComboBox2.AddItem ("MASTERCARD STANDARD")

Else
If TextBox12.Value > 6000 Then
ComboBox2.AddItem ("VISA PLATINUM")
ComboBox2.AddItem ("AMEX PLATINUM")
ComboBox2.AddItem ("MASTERCARD PLATINUM")
ComboBox2.AddItem ("VISA ORO")
...
ComboBox9.AddItem ("DNI")
ComboBox9.AddItem ("CE")
ComboBox10.AddItem ("DNI")
ComboBox10.AddItem ("CE")



ComboBox5.AddItem ("Monto minimo")
ComboBox5.AddItem ("Monto total (100%)")
ComboBox5.AddItem ("En cuotas")
ComboBox6.AddItem ("Físico a su domicilio")
ComboBox6.AddItem ("Físico a su trabajo")
ComboBox6.AddItem ("Por correo electrónico")
ComboBox11.AddItem ("Si")
ComboBox11.AddItem ("No")
ComboBox12.AddItem ("Si")
ComboBox12.AddItem ("No")
Image2.Visible = False
Image3.Visible = False
Image4.Visible = False
Image5.Visible = False
