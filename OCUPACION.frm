VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} OCUPACION 
   Caption         =   "OCUPACIÓN CLIENTE - SIAF"
   ClientHeight    =   8610.001
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   8595.001
   OleObjectBlob   =   "OCUPACION.frx":0000
   StartUpPosition =   2  'Centrar en pantalla
End
Attribute VB_Name = "OCUPACION"
...
CLIENTE.TXT_OCUPACION_CLIENTE.Value = Cells(488, 5)
